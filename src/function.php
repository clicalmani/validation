 ...
 * @return bool
 */
function validateFormatString(string $format): bool
{
 ...
 * @return float|int
 */
function parseNumeric(string $value): float|int
{
    $value = trim($value);
 ...
 * @return bool
 */
function validatePattern(string $pattern): bool
{
    if (empty($pattern)) {
        return false;
    }
 ...
 * @return bool
 */
function validateFlags(string $flags): bool
{
